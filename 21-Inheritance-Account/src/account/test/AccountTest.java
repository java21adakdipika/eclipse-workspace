...
//		Account acc1 = new Account(1, "Dipika", 5000);
		...
		System.out.println("Current Account Balance " + acc2.getBalance());
...
//		System.out.println("Account after Deposit " + acc1.getBalance());
		...
		acc2.withdraw(2000);
		System.out.println("Current Account after withdrawal " + acc2.getBalance());
		
		acc3.withdraw(2000);
		System.out.println("Saving Account after withdrawal " + acc3.getBalance());
